...
//         }
//
//         return defaultValue ?? Errors.AlwaysThrow<Token>(new ObjectNotFoundError($"The variable '{x}' is not defined."));
//     }
//
...
//     {
//         if (InternalVariables.EasterEggs && name.Contains("banana", StringComparison.CurrentCultureIgnoreCase))
//             InternalVariables.LOGGER.Warning("Variable names containing 'banana' are slippery: proceed with caution.");
//
